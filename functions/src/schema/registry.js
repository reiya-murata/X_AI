...
const definitions = Object.freeze({
  ...
  scheduledReplyOpportunitySettings: { version: 1, required: ["scheduledReplyOpportunityEnabled"], optional: ["minimumImpressions", "maxPostAgeHours", "generationLimitPerRun", "dailyLimit", "authorCooldownHours", "postCooldownHours", "minOpportunityScore", "qualityScoreMinimum", "unconfirmedLimit", "operatingHoursStart", "operatingHoursEnd", "weights", "version", "updatedAt"] },
  ...
  scheduledReplyOpportunities: { version: 1, required: ["scheduledReplyOpportunityId", "candidatePostId", "status"], optional: ["candidateDocId", "firebaseUid", "authorId", "authorUsername", "authorName", "postText", "postUrl", "sourceTypes", "sourcePostId", "sourcePostUrl", "sourceText", "sourceAuthorName", "sourceAuthorUsername", "sourceCreatedAt", "impressions", "likes", "replies", "reposts", "generatedReply", "generatedAt", "opportunityScore", "qualityScore", "scoreComponents", "selectedReason", "selectionReason", "excludedReasons", "replyDraftId", "replyText", "replyDraft", "generationModel", "promptVersion", "idempotencyKey", "openedAt", "sentConfirmedAt", "generationResult", "notificationSentAt", "dismissedAt", "skippedAt", "createdAt", "updatedAt", "runKey", "dayKey"] },
});
