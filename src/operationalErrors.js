const messages = [
  ...
  [["callable not found", "functions/not-found", "not found"], "Callableが見つかりません。関数名、リージョン、Functions Emulator接続を確認してください。"],
  [["functions/unavailable", "unavailable", "failed-precondition"], "Functionsへ接続できません。接続先、リージョン、デプロイ状態を確認してください。"],
  [["unauthenticated"], "未認証です。Firebase Authのログイン状態を確認してください。"],
  [["X_NOT_CONNECTED"], "Xへ接続されていません。X接続画面からOAuthをやり直してください。"],
  [["project", "mismatch"], "Firebase projectが想定と一致しません。本番準備画面でprojectIdを確認してください。"],
  [["region mismatch", "region"], "Functionsのリージョンが一致していません。接続先リージョンを確認してください。"],
