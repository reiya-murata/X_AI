...
const env = { ...process.env, FIREBASE_PROJECT_ID: "demo-x-reply-intelligence", GCLOUD_PROJECT: "demo-x-reply-intelligence", GOOGLE_CLOUD_PROJECT: "demo-x-reply-intelligence", FIRESTORE_EMULATOR_HOST: "127.0.0.1:8081" };
