...
console.log(JSON.stringify({ ok: true, productionMockRejected: true, localProductionProjectRejected: true, nonDemoWritesRejected: true, defaultOpenAiCalls: 0, xPosts: 0, productionWrites: 0 }));
